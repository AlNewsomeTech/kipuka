...
function checkPackageJson() {
  ...
  const expectedScripts = ['dev', 'build', 'lint', 'lint:fix', 'typecheck', 'test:security', 'test:cmmc-data', 'test:canonical-migration', 'test:canonical-runtime', 'test:canonical-dashboard', 'test:canonical-readiness', 'test:canonical-documents', 'test:canonical-evidence', 'test:control-applicability', 'test:phase7-final-handoff', 'preview'];
