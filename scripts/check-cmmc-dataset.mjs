...
function checkPackageJson() {
  ...
  const expectedScripts = ['dev', 'build', 'lint', 'lint:fix', 'typecheck', 'test:security', 'test:cmmc-data', 'test:canonical-migration', 'test:canonical-runtime', 'test:canonical-dashboard', 'preview'];
